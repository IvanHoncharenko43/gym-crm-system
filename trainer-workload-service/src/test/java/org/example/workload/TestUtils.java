...
public class TestUtils {
    ...
    public static MonthWorkloadDocument getMonthWorkloadEntity(Month month, int trainingSummaryDurationMinutes) {
        MonthWorkloadDocument entity = new MonthWorkloadDocument();
